                ...
                <tr key={crypto.id} className="bg-zinc-800">
                  ...
                  <td className="px-6 py-4 border-zinc-600 border-b">
                    <Sparklines data={crypto?.sparkline_in_7d?.price || []} width={100} height={20}>
                      <SparklinesLine color={crypto.price_change_percentage_24h >= 0 ? '#4caf50' : '#f44336'} />
                      <SparklinesSpots size={2} style={{ fill: crypto.price_change_percentage_24h >= 0 ? '#4caf50' : '#f44336' }} />
                    </Sparklines>
                  </td>
                </tr>
              ))}
